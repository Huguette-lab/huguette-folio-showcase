...
import { ArrowLeft, BookOpen, Lightbulb, Target, Users, Award } from "lucide-react";
...
const Leadership = () => {
  ...
  const sections = [
    ...
    {
      title: "Evaluating My Learning Journey",
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-4xl">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h1 className="text-4xl md:text-5xl font-bold">Leadership Reflection Essay</h1>
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <Card className="p-8 shadow-card">
              ...
              <p className="text-muted-foreground leading-relaxed text-lg">
                Leadership has always been an important part of my personal and academic journey. 
                Building this portfolio gave me the chance to reflect on how far I have come, what 
                experiences transformed me, and how leadership has shaped my mindset and future goals. 
                Through different projects, teamwork opportunities, and challenges, I have developed 
                skills that go beyond the classroom and prepared me for my mission journey and career 
                after graduation.
              </p>
            </Card>
            ...
            <Card className="p-8 shadow-card bg-gradient-hero">
              <h2 className="text-2xl font-semibold text-foreground mb-6">Conclusion</h2>
              <p className="text-muted-foreground leading-relaxed text-lg">
                Overall, my leadership journey has been full of learning moments that shaped who I am today. 
                From leading group projects to applying theories in practice, I have grown into someone who can 
                adapt, listen, and inspire others. This portfolio is not only a collection of documents but also 
                a reflection of my growth and readiness to take on future challenges. I believe that the combination 
                of skills, knowledge, and mindset I developed will continue to guide me as I work toward my mission 
                and long-term goals.
              </p>
            </Card>
            ...
            <div className="text-center">
              <Card className="p-6 bg-gradient-secondary text-brown-foreground shadow-card inline-block">
                <h3 className="text-xl font-semibold mb-4">Continue the Journey</h3>
                <p className="mb-6">
                  This reflection represents just one milestone in my ongoing leadership development.
                </p>
                <Button 
                  onClick={() => navigate("/")}
